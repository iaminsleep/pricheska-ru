...
class TaskSeeder extends Seeder
{
    ...
    public function run()
    {
        $tasks = [
            ...
            [
                'title' => 'Единорог',
                'description' => 'Мне захотелось приобрести новый опыт, поэтому решила сделать причёску, которую можно увидеть на фотографии. Прошу не смеяться, это очень важный этап в жизни для меня. Работа видно не из лёгких, поэтому заплачу щедро.',
                'category_id' => 4,
                'creator_id' => 1,
                'performer_id' => 4,
