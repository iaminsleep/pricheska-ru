...
<head>
    <meta charset="UTF-8">
    <title>Pricheska-ru</title>
    <link rel="stylesheet" href="{{ asset('public/assets/front/tasks/css/front.css') }}" />
            ...
            <div class="main-container page-header__container">
                ...
                @auth
                    <div class="header__account">
                        <a class="header__account-photo">
                            <img src="<?php echo url('/img/user-photo.png'); ?>" width="43" height="44"
                ...
                @guest
                    <div class="header__account--index guest">
                        ...
                        <a href="" class="header__account-registration">
                            Регистрация
                        </a>
                    </div>
                @endguest
            ...
            <div class="main-container page-footer__container">
                ...
                <div class="page-footer__copyright">
                    <a href="https://htmlacademy.ru">
                        <img class="copyright-logo" src="<?php echo url('/img/academy-logo.png'); ?>" width="185" height="63"
